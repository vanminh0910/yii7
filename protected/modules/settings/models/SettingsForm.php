...
class SettingsForm extends CFormModel {
    ...
    public $firstLayerProtection = array(
        'password' => '',
        'enable' => '',
    );
    ...
    public function rules() {
        return (array(
            array('site, dateTime, email, currency, firstLayerProtection', 'CTypeValidator', 'type' => 'array', 'allowEmpty' => false),
        ));
    }
    ...
    static public $list = array(
        ...
        0 => '[UTC-0] Western European Time, Greenwich Mean Time',
    ...
    static public $currencyUnit = array(
        0 => 'USD',
        1 => 'EURO',
        2 => 'VND',
    );
