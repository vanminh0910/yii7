...
class RAuthorizer extends CApplicationComponent {
    ...
    public function getSuperusers() {
        ...
        if ($superusers === array()) {
            $userClass = Rights::module()->userClass;
            $users = CActiveRecord::model($userClass)->findAllByAttributes(array(Rights::module()->userNameColumn => Rights::module()->usernameAccess));
            if ($users != NULL) {
                $superusers[0] = $users[0][Rights::module()->userNameColumn];
            } else {
