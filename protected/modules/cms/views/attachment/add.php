<?php $this->breadcrumbs=array(
	...
	CmsModule::t('Add file')
) ?>

<div class="page-head">
    <h2 class="pull-left"><i class="fa fa-envelope"></i> <?php echo CmsModule::t('Add file') ?></h2>
		...
		$form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
			'htmlOptions'=>array('enctype'=>'multipart/form-data'),
                    ...
                    <div class="form-group">
                        ...
                        <br><br>
                        <?php echo $form->error($model, 'name', array('style' => 'color:red; margin-left:200px')); ?>
                    </div>
