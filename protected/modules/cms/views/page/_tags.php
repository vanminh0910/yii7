<div class="tags well">
	...
	<ul>
		<li><strong>{{block:name}}</strong> &mdash; <em><?php echo CmsModule::t('displays a content block'); ?></em></li>
		<li><strong>{{menu:name}}</strong> &mdash; <em><?php echo CmsModule::t('displays a menu'); ?></em></li>
		...
		<li><strong>{{file:id}}</strong> &mdash; <em><?php echo CmsModule::t('creates a link to an attached file'); ?></em></li>
