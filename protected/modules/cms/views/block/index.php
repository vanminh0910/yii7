...
<div class="page-head">
    <h2 class="pull-left"><i class="fa fa-users"></i><?php echo CmsModule::t('Blocks'); ?></h2>
...
<div class="container">
	<div class="widget">
		<div class="widget-head">
                    ...
                    <div class="pull-left">
                        <button class="btn btn-sm btn-primary" type="button" onclick="window.open('<?php echo $baseUrl . '/backend/cms/block/create' ?>', '_self');"><?php echo '+'.' '.CmsModule::t('Create'); ?></button>
                    </div>
...
//			'template'=>'{items} {pager}',
			'showTableOnEmpty'=>false,
                        ...
                        CHtml::dropDownList(
                                ...
                                'url' => Yii::app()->createAbsoluteUrl('cms/block'))) .
    ...
    function onDelete(id) {
        bootbox.confirm("Are you sure?", function(result) {
            if (result === true) {
                ...
                window.location.href = '<?php echo Yii::app()->getBaseUrl() . '/backend/cms/block/delete/id/'; ?>' + id;
            }
        });
