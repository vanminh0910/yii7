...
class MenuController extends NodeController
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['CmsMenu']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Menu created.'));
	...
	public function actionUpdate($id)
	{
		...
		*/
		...
		if (isset($_POST['CmsMenu']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Menu updated.'));
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Menu deleted.'));

		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
		if (!isset($_GET['ajax']))
			$this->redirect('/Yii7/backend/cms/menu');
	}
