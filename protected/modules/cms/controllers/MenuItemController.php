...
class MenuItemController extends CmsController
{
	...
	public function actionAdd($menuId, $locale)
	{
		...
		if (isset($_POST['CmsMenuItem']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Link added.'));
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['CmsMenuItem']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Link updated.'));
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Link deleted.'));
