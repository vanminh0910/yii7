...
class AttachmentController extends CmsController
{
	...
	public function actionAdd($pageId)
	{
		...
		if (isset($_POST['CmsAttachment']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Attachment added.'));
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Attachment deleted.'));
