...
class MessageController extends NodeController
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['CmsSourceMessage']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Message created.'));
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['CmsSourceMessage'], $_POST['CmsMessage']))
		{
			...
			if ($valid)
			{
				...
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Message updated.'));
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Message deleted.'));
