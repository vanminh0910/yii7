...
class BlockController extends NodeController
{
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['CmsBlock']))
		{
			...
			if ($model->save())
			{
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Block created.'));
	...
	public function actionUpdate($id)
	{
		...
		if (isset($_POST['CmsBlock'], $_POST['CmsBlockContent']))
		{
			...
			if ($valid)
			{
				...
				Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Block updated.'));
	...
	public function actionDelete($id)
	{
		...
		Yii::app()->user->setFlash($this->module->flashes['success'], CmsModule::t('Block deleted.'));

		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
		if (!isset($_GET['ajax']))
			 $this->redirect('/Yii7/backend/cms/block');
	}
