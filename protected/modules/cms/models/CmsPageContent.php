...
class CmsPageContent extends CmsContent
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => '#',
			'pageId' => CmsModule::t('Page'),
			'locale' => CmsModule::t('Locale'),
			'heading' => CmsModule::t('Heading'),
			'body' => CmsModule::t('Body'),
			'url' => CmsModule::t('URL Alias'),
			'pageTitle' => CmsModule::t('Page Title'),
			'breadcrumb' => CmsModule::t('Breadcrumb'),
			'metaTitle' => CmsModule::t('Meta Title'),
			'metaDescription' => CmsModule::t( 'Meta Description'),
			'metaKeywords' => CmsModule::t( 'Meta Keywords'),
			'published' => CmsModule::t('Published'),
		);
	}
