...
class CmsPage extends CmsNode
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'Id',
			'created' => CmsModule::t('Created'),
			'updated' => CmsModule::t('Updated'),
			'name' => CmsModule::t('System name'),
			'parentId' => CmsModule::t('Parent'),
			'type' => CmsModule::t('Type'),
	...
	public function getParentOptionTree()
	{
		...
		$options = array('0' => CmsModule::t('No parent'));
	...
	{
		return CMap::mergeArray(array(''=> CmsModule::t('None')), Yii::app()->controller->module->pageTypes);
	}
