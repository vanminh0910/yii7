...
class CmsAttachment extends CmsActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => CmsModule::t('Name'),
			'extension' => CmsModule::t('Extension'),
			'filename' => CmsModule::t('Filename'),
			'mimeType' => CmsModule::t('Mime Type'),
			'byteSize' => CmsModule::t('Size (bytes)'),
			'file' => CmsModule::t('File'),
		);
	}
