...
class Products extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('description, specifications, tax_id, status, image_id', 'safe'),
            array('product_id, image_id, title, description, price, category_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        return array(
            ...
            'images' => array(self::BELONGS_TO, 'Image', 'image_id'),
    ...
    public function setVariations($variations) {
        $db = Yii::app()->db;
        $db->createCommand()->delete('shop_product_variation', 'product_id = :product_id', array(
            ':product_id' => $this->product_id));

        foreach ($variations as $key => $value) {
            if ($value['specification_id'] && isset($value['title']) && $value['title'] != '') {
    ...
    public function attributeLabels() {
        return array(
            ...
            'tax_id' => Yii::t('ShopModule.shop', 'Tax (%)'),
            'status' => Yii::t('ShopModule.shop', 'Public on Store'),
        );
    }
