...
//					");
    ...
    if ($shippingMethod = Shop::getShippingMethod()) {
        printf('<tr>
				...
				<td class="text-right">%s</td>
				<td>%s</td></tr>', Shop::t('Shipping costs'), Shop::priceFormat($shippingMethod->price), Shop::priceFormat($shippingMethod->price), CHtml::link(Shop::t('edit'), array('//shop/shippingMethod/choose'))
        );
    }
    echo '<tr>
    ...
    if (Yii::app()->controller->id != 'order') {
        ...
        echo CHtml::link(Shop::t('Check out this order'), array(
